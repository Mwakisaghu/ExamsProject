...
public class CreateChoice implements HttpHandler {
    public void handleRequest(HttpServerExchange exchange) throws ParserConfigurationException, IOException, NoSuchAlgorithmException, SAXException {
        ...
        String tableName = "multiple_choices";
        ...
        try {
            ...
            StatusResponses.sendSuccessResponse(exchange, "Choice Created successfully");
        } finally {
            if (connection != null) {
                try {
                    connection.close();
    ...
    private boolean isValidRequest(Map<String, Object> requestBody) {
        ...
        return requestBody.containsKey("multiple_choice_text") && requestBody.containsKey("is_correct");
    }
}
