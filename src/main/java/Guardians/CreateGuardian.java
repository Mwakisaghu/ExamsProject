...
public class CreateGuardian implements HttpHandler {
    public void handleRequest(HttpServerExchange exchange) throws ParserConfigurationException, IOException, NoSuchAlgorithmException, SAXException {
        ...
        try {
            ...
            StatusResponses.sendSuccessResponse(exchange, "Guardian Created successfully");
        } finally {
            if (connection != null) {
                try {
                    connection.close();
    ...
    private boolean isValidRequest(Map<String, Object> requestBody) {
        ...
        return requestBody.containsKey("guardian_name") && requestBody.containsKey("national_identification_no");
    }
}
